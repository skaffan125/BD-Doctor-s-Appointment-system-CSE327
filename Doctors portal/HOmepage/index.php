...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>BD Doctors Clinic- home</title>
  <meta name="title" content="BD Doctors Clinic- home">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo.png" width="136" height="46" alt="BD Doctors Clinic- home">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="navbar-top">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/logo.svg" width="136" height="46" alt="BD Doctors Clinichome">
          </a>
      ...
      <section class="section hero" style="background-image: url('./assets/images/hero-bg.png')" aria-label="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle has-before" data-reveal="left">Welcome To BD Doctor's Clinic</p>

            <h1 class="headline-lg hero-title" data-reveal="left">
              Find Nearest Doctor <br>
              through BD Doctor's Appointment system
            </h1>
            ...
            <div class="wrapper">
              ...
              <ul class="about-list">
                ...
                <li class="about-item" data-reveal="left">
                  ...
                  <span class="span"> Doctors of BD</span>
                </li>
    ...
    <div class="container">
      ...
      <div class="section footer-top">
        ...
        <div class="footer-brand" data-reveal="bottom">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/logo.svg" width="136" height="46" loading="lazy" alt="">
          </a>
          ...
          <ul class="contact-list has-after">
            ...
            <li class="contact-item">
              ...
              <div>
                <p>
                  Main Email : <a href="#" class="contact-link">contact@&shy</a>
                </p>

                <p>
                  Inquiries : <a href="mailto:Info@mail.com" class="contact-link">admin@bddoc.com</a>
                </p>
              </div>
            ...
            <li class="contact-item">
              ...
              <div>
                <p>
                  Office Telephone : <a href="" class="contact-link">123</a>
                </p>

                <p>
                  Mobile : <a href="" class="contact-link">235</a>
                </p>
              </div>
